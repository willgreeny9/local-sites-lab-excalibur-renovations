        ...
        <div className="concept-backdrop" role="presentation">
          ...
          >
            ...
            <h2 id="concept-title" ref={titleRef} tabIndex={-1}>
              A clearer website to win more local renovation work.
            </h2>
            <p id="concept-description">
              William Green at Local Sites Lab built this sample site for{" "}
              <strong>Excalibur Renovations Ltd</strong> to show how a clearer website could bring
              in more local enquiries. This is not the live or official site — the business did not ask for it and has not approved it.
            </p>
            <div className="concept-actions">
              <a className="button button-lsl" href="https://localsiteslab.com" onClick={dismiss}>
                Get a site like this
              </a>
              <button type="button" className="concept-continue" onClick={dismiss}>
                Continue to Excalibur Renovations
              </button>
            </div>
          </section>
        </div>
